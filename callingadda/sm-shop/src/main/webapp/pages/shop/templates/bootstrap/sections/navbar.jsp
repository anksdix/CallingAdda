...
<div class="navbar navbar-tshop navbar-fixed-top megamenu" role="navigation">
                        ...
                        <ul class="userMenu ">
                            ...
                            <li class="phone-number"><a href="callto:+12025550151"> <span> <i
                                    class="glyphicon glyphicon-phone-alt "></i></span> <span class="hidden-xs"
                                                                                             style="margin-left:5px"> +918884946688 </span>
                            </a></li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand " href="index.html"> <img src="<c:url value="/resources/customs/images/logo.png" />" alt="TSHOP"> </a>
                    ...
                    <table>
                        ...
                        <tr class="miniCartProduct">
                            <td style="width:20%" class="miniCartProductThumb">
                                <div><a href="product-details.html"> <img src="<c:url value="/resources/customs/images/product/3.jpg" />" alt="img"> </a>
                                </div>
                            </td>
                            <td style="width:40%">
                        ...
                        <tr class="miniCartProduct">
                            <td style="width:20%" class="miniCartProductThumb">
                                <div><a href="product-details.html"> <img src="<c:url value="/resources/customs/images/product/2.jpg" />" alt="img"> </a>
                                </div>
                            </td>
                            <td style="width:40%">
                                <div class="miniCartDescription">
                        ...
                        <tr class="miniCartProduct">
                            <td style="width:20%" class="miniCartProductThumb">
                                <div><a href="product-details.html"> <img src="<c:url value="/resources/customs/images/product/5.jpg" />" alt="img"> </a>
                                </div>
                            </td>
                            <td style="width:40%">
                                <div class="miniCartDescription">
                        ...
                        <tr class="miniCartProduct">
                            <td style="width:20%" class="miniCartProductThumb">
                                <div><a href="product-details.html"> <img src="<c:url value="/resources/customs/images/product/4.jpg" />" alt="img"> </a>
                                </div>
                            </td>
                            <td style="width:40%">
                                <div class="miniCartDescription">
                        ...
                        <li class="megamenu-content ">
                            ...
                            <ul class="col-lg-3  col-sm-3 col-md-3  col-xs-4">
                                <li><a class="newProductMenuBlock" href="product-details.html"> <img
                                        class="img-responsive" src="<c:url value="/resources/customs/images/site/promo1.jpg" />" alt="product"> <span
                                        class="ProductMenuCaption"> <i class="fa fa-caret-right"> </i> JEANS </span>
                                </a></li>
                            </ul>
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                                <li><a class="newProductMenuBlock" href="product-details.html"> <img
                                        class="img-responsive" src="<c:url value="/resources/customs/images/site/promo2.jpg" />" alt="product"> <span
                                        class="ProductMenuCaption"> <i
                                        class="fa fa-caret-right"> </i> PARTY DRESS </span> </a></li>
                            </ul>
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                                <li><a class="newProductMenuBlock" href="product-details.html"> <img
                                        class="img-responsive" src="<c:url value ="/resources/customs/images/site/promo3.jpg" />" alt="product"> <span
                    ...
                    <ul class="dropdown-menu">
                        <li class="megamenu-content">
                            ...
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                                <li class="no-margin productPopItem "><a href="<c:url value ="/resources/customs/product-details.html" />"> <img
                                        class="img-responsive" src="<c:url value ="/resources/customs/images/site/g4.jpg" />" alt="img"> </a> <a
                                        class="text-center productInfo alpha90" href="<c:url value ="/resources/customs/product-details.html" />"> Eodem modo
                                    typi <br>
                                    <span> $60 </span> </a></li>
                            </ul>
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                                <li class="no-margin productPopItem relative"><a href="<c:url value ="/resources/customs/product-details.html" />"> <img
                                        class="img-responsive" src="<c:url value ="/resources/customs/images/site/g5.jpg" />" alt="img"> </a> <a
                                        class="text-center productInfo alpha90" href="<c:url value ="/resources/customs/product-details.html" />"> Eodem modo
                                    typi <br>
                                    <span> $60 </span> </a></li>
                            </ul>
                    ...
                    <div class="dropdown-menu col-lg-4 col-xs-12 col-md-4 ">
                        <div class="w100 miniCartTable scroll-pane">
                            <table>
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<c:url value = "resources/customs/mages/product/3.jpg" />" alt="img">
                                        </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<c:url value = "resources/customs/images/product/2.jpg" />" alt="img">
                                        </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<c:url value = "resources/customs/images/product/5.jpg" />" alt="img">
                                        </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<c:url value = "resources/customs/images/product/3.jpg" />" alt="img">
                                        </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<c:url value = "resources/customs/images/product/4.jpg" />" alt="img">
                                        </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<c:url value = "resources/customs/images/site/winter.jpg" />"
                                                                                  alt="img"> </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
